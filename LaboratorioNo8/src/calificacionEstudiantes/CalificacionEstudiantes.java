...
public class CalificacionEstudiantes {
	public static void main(String Arg[]) throws IOException {
		...
		double def;
		int reint;
		// Creación de los 3 objetos, uno por cada estudiante
		...
		do {
			// Se llama al método que introduce los datos en cada objeto
			Est1.entradaDatos(nombre, apellido, 1);
			Est2.entradaDatos(nombre, apellido, 2);
			Est3.entradaDatos(nombre, apellido, 3);
			System.out.println("\n");
			// Se obtiene el apellido y el nombre usando método getter, y se imprimen las
			// notas usando el método imprimir
